  ...
  <div className="relative h-[520px] flex items-center justify-center">
    ...
    {cards.map((card, i) => {
      ...
      if (offset === 0)
        ...
        position = "z-20 scale-90 translate-x-52 rotate-6 opacity-60";
      else
        position = "z-10 scale-90 -translate-x-52 -rotate-6 opacity-60";
      ...
      return (
        ...
        <div
          key={i}
          className={`absolute transition-all duration-700 ease-[cubic-bezier(.22,1,.36,1)] ${position}`}
          style={{
            transform: `translate(${mouse.x * (isActive ? 1 : 0.6)}px, ${
              mouse.y * (isActive ? 1 : 0.6)
            }px)`
          }}
        >
