...
const res = await fetch("/api/claim-club", {
method: "POST",
...
<section id="claim-club" className="scroll-mt-24 py-32 bg-[#344E41] px-6">

<div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-20 items-start">

{/* LEFT COLUMN — FORM */}

<div className="bg-white border border-white/30 p-8 rounded-xl shadow-sm space-y-4">

<div className="text-xs tracking-widest uppercase text-[#A3B18A] mb-2">
Club Founder
</div>

<h2 className="text-3xl font-serif text-[#344E41] mb-4">
Claim your Club
</h2>
...
Running clubs, sports teams, hobby groups and social clubs can use Kinjo
to organise events, communicate with members and grow their local community.
</p>
